...
<section class="hero">
  <div class="hero-content">
    <div class="main-banner" id="mainBanner">
      <img src="<%= request.getContextPath() %>/resources/images/banner1.png" class="active">
  ...
  <div class="floating-button">
    <a href="#">
      <img src="/images/selltalk.png" alt="매각 접수 아이콘" class="process-icon">
    </a>
  </div>
</section>
...
<section class="process-section">
  ...
  <div class="process-container">
    <div class="process-step">
      <img src="/images/proc1.png" alt="매각 접수 아이콘" class="process-icon">
      <h3>원하는 상품 찜</h3>
      <p>증고 거래를 원하는 상품 찜하기</p>
    </div>
    <div class="arrow">&#10140;</div>
    <div class="process-step">
      <img src="/images/proc2.png" alt="제품 회수 아이콘" class="process-icon">
      <h3>채팅 하기</h3>
      <p>상품을 판매하는 판매자와 채팅하기</p>
    </div>
    <div class="arrow">&#10140;</div>
    <div class="process-step">
      <img src= "/images/proc3.png" alt="제품 검사 아이콘" class="process-icon">
      <h3>약속 잡기</h3>
      <p>판매자와 약속 잡기(직거래 or 택배거래)</p>
    </div>
    <div class="arrow">&#10140;</div>
    <div class="process-step">
      <img src="/images/proc4.png" alt="보상 지급 아이콘" class="process-icon">
      <h3>구매 완료</h3>
      <p>원하는 상품을 받아보기</p>
    </div>
  </div>
